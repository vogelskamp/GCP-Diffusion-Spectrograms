...
class UNet(nn.Module):
    def __init__(self, c_in=1, c_out=1, img_width=128, img_height=512, time_dim=256, device="cuda"):
        ...
        self.sa1 = SelfAttention(64, int(img_width/2), int(img_height/2))
        self.down2 = Down(64, 128)
        self.sa2 = SelfAttention(128, int(img_width/4), int(img_height/4))
        self.down3 = Down(128, 128)
        self.sa3 = SelfAttention(128, int(img_width/8), int(img_height/8))
